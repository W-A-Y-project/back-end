...
CREATE TABLE CHAT (
    ...
    User1_CPF CHAR(11) NOT NULL,
    User2_CPF CHAR(11) NOT NULL,
    CreatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (User1_CPF) REFERENCES User(CPF),
    FOREIGN KEY (User2_CPF) REFERENCES User(CPF)
);
...
CREATE TABLE MESSAGE (
    ...
    ChatID INT NOT NULL,
    Sender_CPF CHAR(11) NOT NULL,
    Text TEXT NOT NULL,
    SentAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (ChatID) REFERENCES CHAT(ChatID),
    FOREIGN KEY (Sender_CPF) REFERENCES User(CPF)
);
